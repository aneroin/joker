...
<div class="section no-pad-bot" id="head-banner">
    <img src="<?php echo URL; ?>img_m/office.png"></img>
</div>
        ...
        <div class="row">
            <div  class="col s12 m4 l4">
                <div class="center promo promo-example">
                    ...
                    <h5 class="promo-caption"><?php echo $data['dispatchers_collective'] ?></h5>
            ...
            <div class="col s12 m4 l4">
                <div class="center promo promo-example">
                    ...
                    <h5 class="promo-caption"><?php echo $data['dispatchers_time'] ?></h5>
            ...
            <div class="col s12 m4 l4">
                <div class="center promo promo-example">
                    ...
                    <h5 class="promo-caption"><?php echo $data['dispatchers_income'] ?></h5>
                    <p class="light center">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
                </div>
            </div>
        </div>
...
<div class="parallax-container">
    ...
    <div class="parallax">
        <img src="<?php echo URL; ?>img_m/parallax3.png">
    </div>
</div>
