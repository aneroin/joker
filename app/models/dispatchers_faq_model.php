<?php
session_start();
  class Dispatchers_FAQ_Model extends Model {
   public function __construct($lang = 'ua', $city = 'te') {
    parent::__construct();
    //pre init
    $this->data['current_page_url'] = "dispatchers/faq";
    $this->data['current_page'] = "dispatchers/dispatchers_sub_faq";
    ...
    $sql_faq = "SELECT id, t{$lang}, a{$lang} FROM faq_dispatchers WHERE local =?";
    //prepare globals
